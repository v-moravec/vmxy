<template>
  <div class="container mx-auto flex items-center justify-center min-h-screen">
    <div class="flex flex-col lg:flex-row gap-10 xl:gap-32 items-center">
      ...
      <svg v-if="false" id="Vrstva_7" class="w-32 lg:w-64" data-name="Vrstva 7" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 94.58 55.52">
        <defs>
